    ...
    cases: [
      {
        ...
        result: "568 leads scouted, 210 sites built across 14 verticals, 177 live.",
        href: "/work/pipeline",
      ...
      },
      {
        ...
        result:
          "210 shipped sites and the veto still has room. It also caught two CSS prefix collisions that were silently rendering one design with another's colors.",
      },
      {
        id: "overnight",
        ...
        built:
          "A scheduled overnight workflow that picks the businesses, builds and deploys their sites, verifies each one live, writes the outcome back into 14 vertical pipelines and two boards, and leaves a machine-readable summary.",
        ...
        result:
          "80+ sites built with nobody watching, over 15 nightly runs; best night 9 of 9. It aborts on preflight rather than half-finishing, which is the behavior I actually wanted.",
      },
    ],
  },
  {
    ...
    cases: [
      {
        ...
        result:
          "Load time down 80% to 14 seconds. A 2,000-line editor refactored to 45% less complexity with zero regressions. Led the Vue 3 + Pinia migration; composables adopted team-wide.",
      ...
      },
      {
        ...
        result:
          "Build time down 40% (18.8 → 11.4 s) and the main bundle down 53% (1,834 → 858 kB) via route-based code splitting.",
      },
    ],
  },
];
