...
export function Section({ id, index, title, kicker, children }: SectionProps) {
  return (
    <section id={id} aria-labelledby={`${id}-title`} className="shell scroll-mt-24 py-20 sm:py-28">
      <Reveal>
        <div className="mb-12 flex items-baseline gap-4 border-b border-line pb-5">
          ...
          <h2 id={`${id}-title`} className="font-display text-2xl font-semibold tracking-tight sm:text-3xl">
            {title}
          </h2>
